...
```javascript
import id2msg from 'https://cdn.jsdelivr.net/gh/stdlib-js/error-tools-id2msg@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/error-tools-id2msg/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/error-tools-id2msg/actions/workflows/test.yml?query=branch:v0.2.3
