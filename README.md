...
```javascript
id2msg = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/error-tools-id2msg@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/error-tools-id2msg@v0.2.3-umd/browser.js"></script>
```
